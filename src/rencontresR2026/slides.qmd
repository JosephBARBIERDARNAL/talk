...
Cette présentation s’adresse aux utilisateurs de R qui souhaitent mieux comprendre ce qui fait la singularité du langage, ainsi qu’aux développeurs Python curieux de ses concepts.
...
Dans cette partie, j’expliquerai ce qu’il se passe lorsque l’on décide d’apprendre le langage R, notamment lorsque l’on utilise déjà Python. J’aborderai la manière d’appréhender l’apprentissage d’un nouveau langage, les erreurs fréquentes à éviter, et expliquerai brièvement pourquoi la guerre des langages n’est pas pertinente.
