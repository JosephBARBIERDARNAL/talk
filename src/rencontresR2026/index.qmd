...
- Langage qui gagne en popularité
  - sur des gros projets (Linux, Firefox, Windows, Deno, ...)
  - et dans des grosses entreprises (AWS, Dropbox, Cloudflare, Discord...)
...
- La référence pour un package qui a besoin de performance+
...
- Mais c'est bien de savoir comment fonctionne les outils qu'on utilise
  - rien n'est magique !
